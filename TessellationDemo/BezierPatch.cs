...
namespace TessellationDemo
{
    public class BezierPatch : IDisposable
    {
        ...
        public static BezierPatch Example()
        {
            ...
            {
                {new(-3, 0, -3), new(-2, 0, -3), new(-1, 0, -3), new(0, 0, -3), new(1, 0, -3), new(2, 0, -3), new(3, 0, -3)},
                {new(-3, 0, -2), new(-2, 0, -2), new(-1, 0, -2), new(0, 0, -2), new(1, 0, -2), new(2, 0, -2), new(3, 0, -2)},
                {new(-3, 0, -1), new(-2, 0, -1), new(-1, 0, -1), new(0, 0, -1), new(1, 0, -1), new(2, 0, -1), new(3, 0, -1)},
                {new(-3, 0, 0), new(-2, 0, 0), new(-1, 0, 0), new(0, 0, 0), new(1, 0, 0), new(2, 0, 0), new(3, 0, 0)},
                {new(-3, 0, 1), new(-2, 0, 1), new(-1, 0, 1), new(0, 0, 1), new(1, 0, 1), new(2, 0, 1), new(3, 0, 1)},
                {new(-3, 0, 2), new(-2, 0, 2), new(-1, 0, 2), new(0, 0, 2), new(1, 0, 2), new(2, 0, 2), new(3, 0, 2)},
                {new(-3, 0, 3), new(-2, 0, 3), new(-1, 0, 3), new(0, 0, 3), new(1, 0, 3), new(2, 0, 3), new(3, 0, 3)}
            };
